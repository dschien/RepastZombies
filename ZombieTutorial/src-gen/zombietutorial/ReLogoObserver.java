...
public class ReLogoObserver extends BaseObserver{
	...
	public AgentSet<zombietutorial.relogo.Infection> infections(){
		...
		for (Object e : this.getContext().getObjects(zombietutorial.relogo.Infection.class)) {
	...
	public zombietutorial.relogo.Infection infection(Number oneEnd, Number otherEnd) {
		return (zombietutorial.relogo.Infection)(this.getNetwork("Infection").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
